...
print(ancombc_top20 |> select(taxon, Phylum, Family, all_of(c(lfc_col, q_col))))
...
print(ancombc_top20_lyrebird |> select(taxon, Family, all_of(c(lfc_col_lyrebird, q_col_lyrebird))))
