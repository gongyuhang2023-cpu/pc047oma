...
if (has_phage) {
  ...
  if (nrow(sig_pairs) > 0) {
    ...
    write.csv(cross_pairs_df,
              file = here::here("data", params$name, "07_bacteria_phage_associations.csv"),
              row.names = FALSE)
  } else {
...
if (has_phage) {
  ...
  write.csv(bact_phage_stats_df,
            file = here::here("data", params$name, "08_bacteria_phage_network_stats.csv"),
            row.names = FALSE)
}
```
...
if (has_phage) {
  ...
  ggsave(
    filename = here::here("data", params$name, "09_bacteria_phage_modularity_comparison.png"),
...
if (has_phage) {
  ...
  png(here::here("data", params$name, "10_bacteria_phage_network_2x2.png"),
  ...
  cat("2x2 网络对比图已保存: 10_bacteria_phage_network_2x2.png\n")
}
```
...
cat("2. 进行Zi-Pi分析识别keystone species\n")
...
if (has_phage) {
  cat("  - 07_bacteria_phage_associations.csv\n")
  cat("  - 08_bacteria_phage_network_stats.csv\n")
  cat("  - 09_bacteria_phage_modularity_comparison.png\n")
  cat("  - 10_bacteria_phage_network_2x2.png\n")
}
```
